...
samplesFile = os.path.join(args.dataDir, '_korali_samples/latest')
...
db = np.array(samples['Results']['Posterior Sample Database'])
...
R0 = get_samples('R0')
tint = get_samples('tact')
dint = get_samples('dtact')
gamma = 5.2 #get_samples('gamma')
