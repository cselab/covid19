...
PYTHONPATH=../..:../../build:$PYTHONPATH python sample.py -nt 12 -ns 1000 -np 20 -cm "country.sir.tnrm" -c "germany" --sampler 'mTMCMC'
...
#PYTHONPATH=../..:../../build:$PYTHONPATH python sample.py -nt 12 -ns 25000 -cm "country.sir_int_r0.tnrm" -c "switzerland" --sampler 'mTMCMC'
...
#PYTHONPATH=../..:../../build:$PYTHONPATH python sample.py -nt 12 -ns 5000 -cm "country.sir.tnrm" -c "switzerland" --sampler 'mTMCMC'
#PYTHONPATH=../..:../../build:$PYTHONPATH python sample.py -nt 12 -ns 2000 -cm "country.sir.tnrm" -c "switzerland"
