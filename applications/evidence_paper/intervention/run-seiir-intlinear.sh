...
declare -a models=(
#"country.reparam.seiird_int.poi"
"country.reparam.seiird_int.geo"
"country.reparam.seiird_int.nbin"
#"country.reparam.seiird_int.tnrm"
#"country.reparam.seiird_int.tstudent"
#"country.reparam.seiird_int.tstudent_alt"
)
