...
parser.add_argument('--futureDays', '-fd', type=int, default=0, help='Propagate that many days in future, after the time of observation of the last data.')
...
a.load_parameters(a.saveInfo['korali samples'])
