...
declare -a models=(
#"country.reparam.seiru_int.poi"
#"country.reparam.seiru_int.geo"
"country.reparam.seiru_int.nbin"
#"country.reparam.seiru_int.tnrm"
#"country.reparam.seiru_int.tstudent_alt"
)
