...
def main():
    ...
    generate_country('sir', 'sir_int', 'sir_int_r0', 'seir', 'seir_int', 'seiir', 'seiir_int',
                     ...
                     'cz_int', 'cz_intsmooth', 'cz_intexp', 'cz_intstep', 'spird_int_reparam', 'spird_ints_reparam', 'spiird_int_reparam', 'spiird_ints_reparam', 'seirud_int_reparam', 'seirud_ints_reparam')
