...
def main():
    ...
    generate_country('sir', 'sir_int', 'sir_int_r0', 'seir', 'seir_int', 'seiir', 'seiir_int',
                     ...
                     'seirdg_int_reparam',
                     'seiir_reparam', 'seiir_int_reparam', 
                     'seiird_int_reparam', 'seiir_intexp_reparam', 'seiir_intrem_reparam',
                     'seiird2_int_reparam', 'seiird2_intexp_reparam', 'seiird2_ints_reparam', 'seiird2_intsmooth_reparam', 
                     'seiirdg_int_reparam',
                     'cz_int', 'cz_intsmooth', 'cz_intexp', 'cz_intstep', 
                     'spird_int_reparam', 'spird_ints_reparam', 
                     'spiird_int_reparam', 'spiird_ints_reparam', 'spiird_intexp_reparam', 
